/**
* Provides support for projects (collections of configuration an input data)
* which are helpful in customizing Kahina applications to avoid repetitive tasks..
* <p>
