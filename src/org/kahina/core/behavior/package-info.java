...
* This is especially the case when golabl tree or graph views are used to represent 
...
* <p>
* {@link org.kahina.core.behavior.KahinaDAGBehavior} and {@link org.kahina.core.KahinaTreeBehavior}
* are stub behaviors for directed acylic graphs (i.e. {@link org.kahina.data.tree.KahinaTree}) 
* and trees (i.e. {@link org.kahina.data.tree.KahinaTree}), respectively.
* 
* @since 1.0 
*/ 
