 ...
 * usually define their data types by writing a class that implements this
 * interface. Such classes must be implemented in such a way that the state of
 * an object is fully defined by its ID and the values of the
 ...
 * 
 */
public interface LightweightKahinaObject
{
}
